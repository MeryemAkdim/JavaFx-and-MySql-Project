...
public class Pro {
	...
	String id_cat;
		...
		public Pro(int id_prod, String name_prod, int quantity_prod, double price_prod, String desc_prod, String id_cat) {
		super();
	...
	public Pro(String name_prod, int quantity_prod, double price_prod, String desc_prod, String id_cat) {
		this.name_prod = name_prod;
		this.quantity_prod = quantity_prod;
		this.price_prod = price_prod;
		this.desc_prod = desc_prod;
